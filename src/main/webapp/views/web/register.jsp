        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    <div id="success"></div>
                    <form name="sentMessage" id="contactForm" novalidate="novalidate" method="post" action="RegisterController">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" name="middleName" placeholder="Mid Name"
                                required="required" data-validation-required-message="Please enter your mid name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control"  name="userName" placeholder="User Name"
                                required="required"
                                data-validation-required-message="Please enter your username"></input>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
