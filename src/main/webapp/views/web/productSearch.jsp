            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                 ...
                 <c:forEach var="product" items="${listProductRequest.getListProduct()}">
                    ...
                    <div class="col-12 pb-1 pagingSearch">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center mb-3">
                            <li class="page-item paging-itemSearch prev" data-page="${currentPage - 1}" data-key="${keyword}">
                            ...
                            <c:forEach begin="1" end="${totalPages}" var="i">
										<c:choose>
											<c:when test="${currentPage eq i}">
												<li class="page-item paging-itemSearch active" data-page="${i}" data-key="${keyword}"><a class="page-link" href="#">${i}</a></li>
											</c:when>
											<c:otherwise>
												<li class="page-item paging-itemSearch" data-page="${i}" data-key="${keyword}"><a class="page-link" href="#">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
                            
                            <li class="page-item paging-itemSearch next" data-page="${currentPage + 1}" data-key="${keyword}">
